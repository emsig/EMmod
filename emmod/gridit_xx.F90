SUBROUTINE gridit_xx (Ptot,xtotrad1,xtotrad2,dx,nxh,dy,nyh,xpos,nlogx,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,gamB,above,xdirect)
...
REAL                  :: realtemp1, imagtemp1, realtemp2, imagtemp2
...
SUBROUTINE gridit_xx_fullspace (Ptot,dx,nxh,dy,nyh,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,gamB)
...
END SUBROUTINE gridit_xx_fullspace
	  
SUBROUTINE gridit_xy (Ptot,xtotrad1,dx,nxh,dy,nyh,xpos,nlogx,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,gamB,above,xdirect)
! Compute the data of one quadrant of the grid based on the radial data using pchip interpolation
...
SUBROUTINE gridit_xy_fullspace (Ptot,dx,nxh,dy,nyh,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,gamB)
! Compute the data of one quadrant of the grid for a homogeneous fullspace
! for component 12 (inline oriented electric receiver, crossline oriented electric source).
! 
! Calling arguments:
...
END SUBROUTINE gridit_xy_fullspace 

SUBROUTINE gridit_xz (Ptot,xtotrad1,dx,nxh,dy,nyh,xpos,nlogx,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,above,xdirect)
! Compute the data of one quadrant of the grid based on the radial data using pchip interpolation
...
SUBROUTINE gridit_xz_fullspace (Ptot,dx,nxh,dy,nyh,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA)
! Compute the data of one quadrant of the grid for a homogeneous fullspace
! for component 13 (inline oriented electric receiver, vertical electric source).
! 
! Calling arguments:
...
END SUBROUTINE gridit_xz_fullspace
