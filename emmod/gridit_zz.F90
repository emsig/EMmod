SUBROUTINE gridit_zx (Ptot,xtotrad1,dx,nxh,dy,nyh,xpos,nlogx,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,above,xdirect)
...
SUBROUTINE gridit_zx_fullspace (Ptot,dx,nxh,dy,nyh,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA)
...
END SUBROUTINE gridit_zx_fullspace

SUBROUTINE gridit_zy (Ptot,xtotrad1,dx,nxh,dy,nyh,xpos,nlogx,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,above,xdirect)
! Compute the data of one quadrant of the grid based on the radial data using pchip interpolation
...
SUBROUTINE gridit_zy_fullspace (Ptot,dx,nxh,dy,nyh,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA)
! Compute the data of one quadrant of the grid for a homogeneous fullspace
! for component 32 (vertical electric receiver, crossline oriented electric source).
! 
! Calling arguments:
...
END SUBROUTINE gridit_zy_fullspace

SUBROUTINE gridit_zz (Ptot,xtotrad1,dx,nxh,dy,nyh,xpos,nlogx,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA,above,xdirect)
! Compute the data of one quadrant of the grid based on the radial data using pchip interpolation
...
SUBROUTINE gridit_zz_fullspace (Ptot,dx,nxh,dy,nyh,zrcv,zsrc,etaH,etaV,zetaH,zetaV,gamA)
! Compute the data of one quadrant of the grid for a homogeneous fullspace
! for component 33 (vertical electric receiver, vertical electric source).
! 
! Calling arguments:
...
END SUBROUTINE gridit_zz_fullspace
