SUBROUTINE hankeltransyxm (xtotrad1,xtotrad2,marker,temptot1,temptot2,corel,cor,xpos,nlogx,nd,kmax)
! Perform Hankel Transformation for component 51 (crossline oriented magnetic receiver, inline oriented electric source) 
!
! Calling arguments:
! xtotrad1: Hankel Transform of the 1st output term of Ptotalyxm, complex array of size nlogx
! xtotrad2: Hankel Transform of the 2nd output term of Ptotalyxm, complex array of size nlogx
! marker:   Indicates for which points in space the Hankel Transformation needs to be computed, integer array of size nlogx
! temptot1: 1st output term of Ptotalyxm, complex array of size corel
! temptot2: 2nd output term of Ptotalyxm, complex array of size corel
...
COMPLEX               :: integrand1(corel), integrand2(corel), tempin1(61), tempin2(61), temp
REAL                  :: kintel, pi, BesJ0, BesJ2
...
END SUBROUTINE hankeltransyxm

SUBROUTINE hankeltransyym (xtotrad,marker,temptot,corel,cor,xpos,nlogx,nd,kmax)
! Perform Hankel Transformation for component 52 (crossline oriented magnetic receiver, crossline oriented electric source) 
!
! Calling arguments:
! xtotrad: Hankel Transform of the output term of Ptotalyym, complex array of size nlogx
! marker:  Indicates for which points in space the Hankel Transformation needs to be computed, integer array of size nlogx
! temptot: Output term of Ptotalyym, complex array of size corel
! corel:   Amount of points in the wavenumber domain (61 times the amount of integration subdomains nd), integer scalar
! cor:     Coordinates in the wavenumber domain, real array of size corel
! xpos:    Logarithmic coordinate vector in the space domain, real array of size nlogx
! nlogx:   Amount of samples in logarithmic coordinate vector, integer scalar
...
REAL   ,INTENT(IN)    :: cor(corel), xpos(corel), kmax
...
END SUBROUTINE hankeltransyym

SUBROUTINE hankeltransyzm (xtotrad,marker,temptot,corel,cor,xpos,nlogx,nd,kmax)
! Perform Hankel Transformation for component 53 (crossline oriented magnetic receiver, vertical electric source) 
!
! Calling arguments:
! xtotrad: Hankel Transform of the output term of Ptotalyzm, complex array of size nlogx
! marker:  Indicates for which points in space the Hankel Transformation needs to be computed, integer array of size nlogx
! temptot: Output term of Ptotalyzm, complex array of size corel
! corel:   Amount of points in the wavenumber domain (61 times the amount of integration subdomains nd), integer scalar
! cor:     Coordinates in the wavenumber domain, real array of size corel
! xpos:    Logarithmic coordinate vector in the space domain, real array of size nlogx
! nlogx:   Amount of samples in logarithmic coordinate vector, integer scalar
