SUBROUTINE hankeltranszxm (xtotrad,marker,temptot,corel,cor,xpos,nlogx,nd,kmax)
! Perform Hankel Transformation for component 61 (vertical magnetic receiver, inline oriented electric source) 
!
! Calling arguments:
! xtotrad: Hankel Transform of the output term of Ptotalzxm, complex array of size nlogx
! marker:  Indicates for which points in space the Hankel Transformation needs to be computed, integer array of size nlogx
! temptot: Output term of Ptotalzxm, complex array of size corel
...
END SUBROUTINE hankeltranszxm

SUBROUTINE hankeltranszym (xtotrad,marker,temptot,corel,cor,xpos,nlogx,nd,kmax)
! Perform Hankel Transformation for component 62 (vertical magnetic receiver, crossline oriented electric source) 
!
! Calling arguments:
! xtotrad: Hankel Transform of the output term of Ptotalzym, complex array of size nlogx
! marker:  Indicates for which points in space the Hankel Transformation needs to be computed, integer array of size nlogx
! temptot: Output term of Ptotalzym, complex array of size corel
! corel:   Amount of points in the wavenumber domain (61 times the amount of integration subdomains nd), integer scalar
! cor:     Coordinates in the wavenumber domain, real array of size corel
! xpos:    Logarithmic coordinate vector in the space domain, real array of size nlogx
! nlogx:   Amount of samples in logarithmic coordinate vector, integer scalar
